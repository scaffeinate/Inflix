    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_discover:
                ...
                mToolbarTitle.setText(getResources().getString(R.string.discover));
                selected = true;
                break;
            case R.id.action_sort_popular:
                fragment = MoviesFragment.newInstance(MOST_POPULAR);
                mToolbarTitle.setText(getResources().getString(R.string.most_popular));
                selected = true;
                break;
            case R.id.action_sort_rating:
                fragment = MoviesFragment.newInstance(TOP_RATED);
                mToolbarTitle.setText(getResources().getString(R.string.top_rated));
                selected = true;
                break;
            case R.id.action_favorites:
                fragment = LocalMoviesFragment.newInstance(FAVORITES);
                mToolbarTitle.setText(getResources().getString(R.string.favorites));
                selected = true;
                break;
        }
